...
class NewsPage {
  ...
  constructor() {
    this.newsContainer = document.querySelector('.news-container') as HTMLElement;
  ...
  private async showNewsForm(id?: string) {
    ...
    const newsForm = form.querySelector('#news-form') as HTMLFormElement;
  ...
  private showError(message: string = 'Произошла ошибка при загрузке новостей. Пожалуйста, попробуйте позже.') {
